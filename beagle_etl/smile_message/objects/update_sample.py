...
from beagle_etl.smile_message.objects.sample_object import (
    SampleMetadata,
    SampleAlias,
    PatientAlias
)
...
class PatientInfo:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'PatientInfo':
        ...
        return cls(
            smilePatientId=data.get('smilePatientId'),
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'cmoPatientId': {
                'value': self.cmoPatientId.value,
                'namespace': self.cmoPatientId.namespace
            }
        }
...
class UpdateSample:
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'UpdateSample':
        ...
        # Handle sample metadata list
        sample_metadata_list_data = data.get('sampleMetadataList', [])
        sample_metadata_list = [SampleMetadata.from_dict(sample) for sample in sample_metadata_list_data]

        # Handle latest sample metadata
        ...
        return cls(
            smileSampleId=data.get('smileSampleId'),
