...
def construct_inputs(samples, request_id):
    ...
    for sample_files in samples:
        ...
        merge_fastq_fastq1 = [{"class": "File", "location": "iris://" + fastq["path"]} for fastq in fastqs["R1"]]

        merge_fastq_fastq2 = [{"class": "File", "location": "iris://" + fastq["path"]} for fastq in fastqs["R2"]]
