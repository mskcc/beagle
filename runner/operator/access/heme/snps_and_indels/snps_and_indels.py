...
ACCESS_CURATED_BAMS_FILE_GROUP_SLUG = "heme_curated_normals"
ACCESS_DEFAULT_NORMAL_ID = "Donor3F41c2207-TPH01_ACCESSHv1-VAL-20220007"
...
ACCESS_DEFAULT_NORMAL_FILENAME_DUPLEX = (
    "Donor3F41c2207-TPH01_ACCESSHv1-VAL-20220007_cl_aln_srt_MD_IR_FX_BR__aln_srt_IR_FX-duplex.bam"
)
...
class AccessHemeLegacySNV(Operator):
    ...
    def get_jobs(self):
        ...
        runs, self.request_id = get_request_id_runs(
            ["heme nucleo"], self.run_ids, self.request_id
        )
