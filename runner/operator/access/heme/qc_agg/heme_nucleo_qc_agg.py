...
class HemeNucleoQcAggOperator(Operator):
    """
    Operator for the Heme QC AGGREGATE workflow:

    https://github.com/msk-access/nucleo_qc/blob/develop/nucleo_aggregate_visualize.cwl

    This Operator will search for Heme QC files based on an IGO Request ID
    """
