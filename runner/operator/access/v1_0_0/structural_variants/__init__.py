...
ACCESS_DEFAULT_SV_NORMAL_ID = "DONOR00-TP"
ACCESS_DEFAULT_SV_NORMAL_FILENAME = "DONOR00-TP_cl_aln_srt_MD_IR_FX_BR.bam"
...
class AccessLegacySVOperator(Operator):
    ...
    def get_sample_inputs(self):
        ...
        """
        run_ids, self.request_id = get_request_id_runs(["access legacy"], self.run_ids, self.request_id)
