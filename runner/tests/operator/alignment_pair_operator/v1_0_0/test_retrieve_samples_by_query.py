...
from runner.operator.alignment_pair_operator.v1_0_0.bin.retrieve_samples_by_query import build_dmp_query
from runner.operator.alignment_pair_operator.v1_0_0.bin.retrieve_samples_by_query import get_dmp_normal
from runner.operator.alignment_pair_operator.v1_0_0.bin.retrieve_samples_by_query import get_pooled_normals
from runner.operator.alignment_pair_operator.v1_0_0.bin.retrieve_samples_by_query import build_run_id_query
from runner.operator.alignment_pair_operator.v1_0_0.bin.retrieve_samples_by_query import build_preservation_query
from runner.operator.alignment_pair_operator.v1_0_0.bin.retrieve_samples_by_query import get_descriptor
from runner.tests.operator.alignment_pair_operator.v1_0_0.test_pair_request import UUIDEncoder
...
class TestRetrieveSamplesByQuery(TestCase):
    ...
    def test_get_dmp_normal1(self):
        ...
        print(
            "Running test_get_dmp_normal1: expected dmp normal ---\n", json.dumps(expected_dmp_normal, cls=UUIDEncoder)
        )
