...
from runner.operator.argos_bam_operator.v1_0_0.construct_argos_pair import construct_argos_jobs
from runner.operator.argos_bam_operator.v1_0_0.bin.make_sample import build_sample
...
class TestConstructPair(TestCase):
    ...
    def test_construct_argos_jobs1(self):
        ...
        expected_inputs = json.load(
            open(os.path.join(settings.TEST_FIXTURE_DIR, "10075_D_single_TN_pair.argos_bam_1_0_0.input.json"))
        )
