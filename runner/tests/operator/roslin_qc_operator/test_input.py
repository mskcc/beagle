...
class TestInput(TestCase):
    ...
    def test_get_db_files(self):
        ...
        expected_db_files = {
            'conpair_markers': {'class': 'File', 'path': '/usr/bin/conpair/data/markers/GRCh37.autosomes.phase3_shapeit2_mvncall_integrated.20130502.SNV.genotype.sselect_v4_MAF_0.4_LD_0.8.txt'},
            'fp_genotypes': {'class': 'File', 'path': '/juno/work/ci/resources/roslin_resources/targets/IDT_Exome_v1_FP/b37/FP_tiling_genotypes.txt'},
            'hotspot_list_maf': {'class': 'File', 'path': '/juno/work/ci/resources/roslin-qc/hotspot-list-union-v1-v2.maf'},
            'ref_fasta': {'class': 'File', 'path': '/juno/work/ci/resources/genomes/GRCh37/fasta/b37.fasta'}
        }
