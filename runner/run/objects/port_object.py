...
class PortObject(object):
    ...
    def __init__(self, run_id, name, port_type, schema, secondary_files, db_value, value, files, port_id=None):
        self.run_id = run_id
        self.name = name
    ...
    @classmethod
    def from_cwl_definition(cls, run_id, value, port_type, port_values):
        name = value.get('id')
        ...
        return cls(run_id, name, port_type, schema, secondary_files, db_value, value, files)
    ...
    def complete(self, value, group, output_metadata={}):
