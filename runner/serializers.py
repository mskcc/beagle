...
class PairOperatorSerializer(serializers.Serializer):
    ...
    job_group_id = serializers.UUIDField(required=False)
    labHeadName = serializers.CharField(max_length=30, required=False,
                                        allow_blank=True, allow_null=True)
    investigatorName = serializers.CharField(max_length=30, required=False,
                                             allow_blank=True, allow_null=True)
    assay = serializers.CharField(max_length=30, required=False,
                                  allow_blank=True, allow_null=True)
