...
SDK_TEST_OUTPUT_LOCATION = os.environ.get("BEAGLE_SDK_TEST_OUTPUT_LOCATION", "/tmp")
SDK_VENV_LOCATION = os.environ.get("BEAGLE_SDK_VENV_LOCATION", "/tmp")
SDK_DEFAULT_STORAGE = os.environ.get("BEAGLE_DEFAULT_STORAGE")
