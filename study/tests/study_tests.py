...
class TestStudy(APITestCase):
    ...
    def setUp(self):
        ...
        self.sample_t_1 = Sample.objects.create(sample_id='08944_B_1',
                                                sample_name="LTG002_P3_17096_L1",
                                                cmo_sample_name="C-MP76JR-X001-d",
                                                sample_type="Primary",
                                                sample_class="PDX",
                                                tumor_or_normal="Tumor")
        self.sample_n_1 = Sample.objects.create(sample_id='08944_B_2',
                                                sample_name="LTG002_P3_17096_L1",
                                                cmo_sample_name="C-MP76JR-X002-d",
                                                sample_type="Primary",
                                                sample_class="PDX",
                                                tumor_or_normal="Normal")
        self.sample_t_2 = Sample.objects.create(sample_id='08944_B_3',
                                                sample_name="LTG002_P3_17096_L1",
                                                cmo_sample_name="C-MP76JR-X003-d",
                                                sample_type="Primary",
                                                sample_class="PDX",
                                                tumor_or_normal="Tumor")
        self.sample_n_2 = Sample.objects.create(sample_id='08944_B_4',
                                                sample_name="LTG002_P3_17096_L1",
        ...
        with patch('django.utils.timezone.now', Mock(return_value=new_run_date)):
            self.run_2 = Run.objects.create(app=self.pipeline,
                                            run_type=ProtocolType.CWL,
                                            name="Test Run 1",
                                            status=RunStatus.COMPLETED,
                                            notify_for_outputs=[]
        ...
        with patch('django.utils.timezone.now', Mock(return_value=new_run_date)):
            self.run_3 = Run.objects.create(app=self.pipeline,
                                            run_type=ProtocolType.CWL,
                                            name="Test Run 1",
                                            status=RunStatus.COMPLETED,
                                            notify_for_outputs=[]
