...
export PGDATA=$(SINGULARITYENV_BEAGLE_DB_NAME)
export PGUSER=$(SINGULARITYENV_BEAGLE_DB_USERNAME)
export PGHOST=$(BEAGLE_DB_URL)
export PGLOG=$(LOG_DIR_ABS)/postgres.log
export PGPASSWORD=$(SINGULARITYENV_BEAGLE_DB_PASSWORD)
export PGDATABASE=$(SINGULARITYENV_BEAGLE_DB_NAME)
export PGPORT=$(SINGULARITYENV_BEAGLE_DB_PORT)
...
export RABBITMQ_USERNAME:=$(SINGULARITYENV_BEAGLE_RABBITMQ_USERNAME)
export RABBITMQ_PASSWORD:=$(SINGULARITYENV_BEAGLE_RABBITMQ_PASSWORD)
export BEAGLE_RABBITMQ_URL:=amqp://$(SINGULARITYENV_BEAGLE_RABBITMQ_USERNAME):$(SINGULARITYENV_BEAGLE_RABBITMQ_PASSWORD)@$(RABBITMQ_NODE_IP_ADDRESS):$(RABBITMQ_NODE_PORT)
...
export SINGULARITYENV_BEAGLE_RABIX_PATH=$(CURDIR)/conda/bin/rabix
...
export SINGULARITYENV_BEAGLE_RIDGEBACK_URL:=http://$(DJANGO_RIDGEBACK_IP):$(DJANGO_RIDGEBACK_PORT)
...
TOKEN:=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ0
